...
export const GetTodolists = () => {
  ...
  useEffect(() => {
    console.log;
    todoAPI.getTodo().then(data => setState(data));
  }, []);
...
export const CreateTodolists = () => {
  ...
  const onClickHandler = () => {
    todoAPI.createTodo(title).then(data => setState(data));
  };
...
export const DeleteTodolists = () => {
  ...
  const onClickHandler = () => {
    todoAPI.deleteTodo(todoID).then(data => setState(data));
  };
...
export const UpdateTodolists = () => {
  ...
  const onClickHandler = () => {
    todoAPI.updateTodo(todoID, title).then(data => setState(data));
  };
  const onChangeTitleValue = (e: ChangeEvent<HTMLInputElement>) => {
    setTitle(e.currentTarget.value);
  };
